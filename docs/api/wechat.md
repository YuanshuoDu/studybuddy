...
> 详见 [ADR-0006 Mapbox for global](../adr/0006-mapbox-for-global.md) 和 [Issue #35](https://github.com/YuanshuoDu/studybuddy/issues/35)。
...
| 域名 | 类型 |
|------|------|
| `api.studybuddy.example.com` | request 合法域名 |
