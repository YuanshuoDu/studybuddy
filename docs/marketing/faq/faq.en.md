...
StudyBuddy is a **hobby + activity matching app for Chinese students
...
- WeChat Mini Program (search "StudyBuddy")
...
StudyBuddy has 2 gates protecting you and the platform:
...
**Pricing**: StudyBuddy v1.0 is **free**. No service fee, no commission.
...
**Insurance**: StudyBuddy the platform **does not** provide commercial
...
- 📧 Email: [support@studybuddy.app](mailto:support@studybuddy.app)
- 💬 User group: see in-app `Me` → `Join user group`
- 🐛 Issues: [github.com/YuanshuoDu/studybuddy/issues](https://github.com/YuanshuoDu/studybuddy/issues)
