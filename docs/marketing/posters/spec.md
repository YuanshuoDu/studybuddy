...
| CTA | "扫码下载 StudyBuddy" (consistent across all 3 sizes) |
...
headline:   找搭子
            找同好
            找组织
subtitle:   StudyBuddy · 海外留学生同好匹配 App
pitch:      6 种活动 · 50 km 半径 · 3 端通用
cta:        扫码下载 StudyBuddy
fine:       studybuddy.app · 微信小程序搜「StudyBuddy」
```
...
`studybuddy-assets/posters/v{version}/`.
