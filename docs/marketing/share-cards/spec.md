...
> to a StudyBuddy activity. Each has a different aspect ratio, copy
...
All 3 cards share the StudyBuddy brand system (`docs/design/system-v1.md`).
...
```
title:   {发起人昵称}在 StudyBuddy 发起了一个活动
lead:    {活动标题} · 招 {剩余名额} 人
...
│  └──────────────────────────────────────┘   │
│                                             │
│ [logo bottom-left]    [studybuddy.app]      │
└─────────────────────────────────────────────┘
```
...
`studybuddy-assets/share-cards/wechat-moments.{shortSha}.png`. The
...
- Twitter: user wants to publicise StudyBuddy to non-Chinese
