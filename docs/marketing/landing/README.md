# StudyBuddy landing page — `docs/marketing/landing/index.html`

> **What this is** — the in-repo, self-contained landing page for
> `studybuddy.app`. The "production" version (Awwwards-grade, video
...
2. **What is StudyBuddy** — 3-column feature grid (Map, Match, Meet)
...
- `studybuddy.app` (Vercel + CloudFront, EN)
- `studybuddy.app/zh` (same repo, language switcher in URL)
