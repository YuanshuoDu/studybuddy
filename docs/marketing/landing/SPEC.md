...
> landing page that ships to `studybuddy.app`. It assumes a designer
...
| What is StudyBuddy | 3 static cards | 3 cards with hover-triggered Lottie animations (1 per card) |
...
- Hosting: CloudFront, served from `https://cdn.studybuddy.app/landing/hero-loop.{shortSha}.mp4`
...
1. Design team ships static Figma file (`figma.com/studybuddy/landing-v1.1`)
...
4. Vercel preview URL: `studybuddy-landing-v1-1.vercel.app`
5. Smoke: Lighthouse CI on 3 viewports (mobile / tablet / desktop)
6. Stage on `staging.studybuddy.app` for 1 week
7. Promote to production: `studybuddy.app` (CNAME swap)
