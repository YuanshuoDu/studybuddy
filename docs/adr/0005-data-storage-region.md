...
> **关联**：[cto-roadmap-v1.0.md §0 Q5/Q8](../../studybuddy-plan/cto-roadmap-v1.0.md) · [architecture-v1.0.md §7.4 / §9](../architecture-v1.0.md) · [ADR-0003 多端登录合并](./0003-auth-strategy.md)

## Context（背景）

StudyBuddy 的用户群体有清晰的地域分布：
