...
> **关联**：[cto-roadmap-v1.0.md §0 D3](../../Pairhub-plan/cto-roadmap-v1.0.md) · [architecture-v1.0.md §2](../architecture-v1.0.md) · [ADR-0001](./0001-flutter-for-mobile.md)

## Context（背景）

Pairhub 的**主端是微信小程序**（决策人指定）— 留学生群体在国内外的微信渗透率最高，零下载成本。
...
- 12 周窗口
- 微信小程序生态：登录 / 支付 / 订阅消息 / 内容安全 / 分享 — **原生调用**；地图：Mapbox webview（待 [Issue #35](https://github.com/YuanshuoDu/Pairhub/issues/35) 决策）
...
├── 地图：Mapbox webview（GL JS，待 Issue #35 决策）
