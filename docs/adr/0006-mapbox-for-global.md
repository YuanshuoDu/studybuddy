...
v0.2 假设的"小程序用微信 map 组件"在海外主用户场景下不成立。**已决策 B** — 见 [Issue #35](https://github.com/YuanshuoDu/pairhub/issues/35)（已 closed）。
...
- [Issue #35: 小程序地图决策（已选 B）](https://github.com/YuanshuoDu/pairhub/issues/35)
