...
# 兜底：直接用 docker stop
for name in studybuddy-pg studybuddy-redis studybuddy-server; do
...
echo "✅ 本地环境已停止（数据卷已保留：studybuddy_pgdata）"
echo "   如需彻底清理数据：  docker volume rm studybuddy_pgdata"
